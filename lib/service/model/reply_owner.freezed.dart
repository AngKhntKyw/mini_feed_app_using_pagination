...
mixin _$ReplyOwner {
  ...
  set profile_url(String? value) => throw _privateConstructorUsedError;
...
class _$ReplyOwnerImpl extends _ReplyOwner {
  _$ReplyOwnerImpl({required this.id, required this.username, this.profile_url})
      : super._();
...
abstract class _ReplyOwner extends ReplyOwner {
  factory _ReplyOwner(
      ...
      String? profile_url}) = _$ReplyOwnerImpl;
  _ReplyOwner._() : super._();
